...
1.	Обзор языка C#
     + [Первое приложение](https://github.com/latypdin23/FirstProject)
3.	Типы данных
     + [Инициализация переменных и типы данных](https://github.com/latypdin23/Data-Types)
5.	Операторы и исключения
6.	Методы и операторы
...
8.	Основы ООП
9.	Взаимодействие типов
10.	Создание и удаление объектов
    + [Сборщик мусора](https://github.com/latypdin23/GarbageCollector)
11.	Наследование
    + [Паттерны: Стратегия, Singleton, Фабричный метод, Шаблонный метод](https://github.com/latypdin23/Patterns)
12.	Операции, делегаты, события
    + [Перегрузка операторов, использование делегатов и событий](https://github.com/latypdin23/EventAndDelegateAndOverload)
13.	Отношения между классами и объектами
14.	Сортировки
    + [Примеры: Bubble Sort, Coctail Sort, Insertion Sort, Merge Sort, Quick Sort, Selection Sort, Shell Sort](https://github.com/latypdin23/Sorting)
15.	Свойства, индексаторы и атрибуты
#### Разработка приложений на C# ⚡
📑 Теория
1. Элементы управления WinForms
2. Базы данных
    + [Пример работы с Postgres](https://github.com/latypdin23/DataBaseExample)
4. О работе в командах
5. Kanban, Agile, Scrum
6. XML, JSON, Сериализация
    + [Сериализация](https://github.com/latypdin23/Serialization)
7. Логирование
8. Тестирование
    + [Модульное тестирование](https://github.com/latypdin23/UnitTestsExample)
